...
leadRoutes.post("/", requireRole("SALES_PARTNER", "CUSTOMER", "ADMIN"), leadController.create);
leadRoutes.post("/with-documents", requireRole("SALES_PARTNER", "CUSTOMER", "ADMIN"), upload.array("documents", 20), leadController.createWithDocuments);
...
leadRoutes.post("/:id/documents", requireRole("SALES_PARTNER", "SERVICE_PARTNER", "CUSTOMER", "ADMIN"), upload.single("file"), leadController.uploadDocument);
